<x-app-layout>
    ...
    <form action="{{ route('order.delivery') }}" method="POST" class="mt-6 relative" novalidate>
        ...
        <div class="flex justify-between mt-6">
            <a href="{{ route('cart.index') }}" class="p-2 rounded-md bg-gray-200 text-sm font-semibold shadow-sm hover:bg-gray-300 border-zinc-400 border focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 flex items-center">Back to Cart
            </a>
            <button type="submit" class="p-2 rounded-md bg-sky-400 text-sm font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 flex items-center">Continue to Delivery & Payment
            </button>
        </div>
    </form>
