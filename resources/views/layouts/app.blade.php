    ...
    <body class="mx-auto max-w-6xl text-slate-700 text-lg bg-beige font-mono">
        ...
        <div class="flex justify-start">
            ...
            <main class="w-full px-4">
                @if (session('success'))
                    <div role="alert" class="px-4 mx-4 mb-8 rounded-md border-l-4 border-green-300 bg-green-100 p-4 text-green-700 opacity-75">
                ...
                @if (session('error'))
                    <div role="alert" class="px-4 mx-4 mb-8 rounded-md border-l-4 border-red-300 bg-red-100 p-4 text-red-700 opacity-75">
