<x-app-layout>
    ...
    <div class="flex justify-between mt-6">
        ...
        <a href="{{ route('order.address') }}" class="m-2 p-2 my-2 rounded-md bg-sky-400 text-sm font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 flex items-center">Continue</a>
    </div>
</x-app-layout>